!(function (t, e) {
	...
	function R() {
		var t = g(A().querySelectorAll('[tabindex]:not([tabindex="-1"]):not([tabindex="0"])')).sort(
				function (t, e) {
					return (
	...
	var Ft = function (t, e) {
		...
		Qt = function (t, e) {
			(t.className = "".concat($.popup, " ").concat(wt(t) ? e.showClass.popup : "")),
				e.toast
					? (vt([document.documentElement, document.body], $["toast-shown"]), vt(t, $.toast))
					: vt(t, $.modal),
				F(t, e, "popup"),
	...
	var se = {
		...
		de = Object.freeze({
			...
			bindClickHandler: function () {
				(ne[
					0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : "data-swal-template"
				] = this),
	...
	var ge = function () {
		...
		be = function (t) {
			...
			return (
				!ye(t) &&
				!we(t) &&
				(e === n || !(ct(n) || "INPUT" === e.tagName || (ct(P()) && P().contains(e))))
			);
		},
		ye = function (t) {
		...
		Oe = function (t, e, n, o) {
			(te.swalCloseEventFinishedCallback = ke.bind(null, t, n, G(), o)),
				e.addEventListener(Bt, function (t) {
					t.target === e &&
						(te.swalCloseEventFinishedCallback(), delete te.swalCloseEventFinishedCallback);
				});
		},
		Ee = function (t, e) {
			setTimeout(function () {
	...
	var Ve = ["swal-title", "swal-html", "swal-footer"],
		...
		gn = function (t) {
			-1 !== [T(), L(), q()].indexOf(document.activeElement) &&
				((t = -1 !== ln.indexOf(t) ? "nextElementSibling" : "previousElementSibling"),
	...
	function An(t, e) {
		...
		return (
			...
			(n.hideClass = i),
			!1 === t.animation &&
				((n.showClass = { popup: "swal2-noanimation", backdrop: "swal2-noanimation" }),
				(n.hideClass = {})),
			n
		);
	}
		...
		return new Promise(function (t) {
			...
			Ce.swalPromiseResolve.set(a, t),
				(s.confirmButton.onclick = function () {
					return (
						(e = u), (t = a).disableButtons(), void (e.input ? an(t, e, "confirm") : cn(t, e, !0))
					);
					var t, e;
				}),
			...
			update: function (e) {
				...
				Object.keys(e).forEach(function (t) {
					...
					Object.defineProperties(this, {
						params: { value: u({}, this.params, e), writable: !1, enumerable: !0 },
					});
			},
			_destroy: function () {
				var t = Tt.domCache.get(this),
